...
rem SET CompOpts= /nologo /O2 /inline /traceback /libs:static /threads /iface:cref /names:uppercase
SET CompOpts= /nologo /O2 /inline /traceback /libs:dll /threads /iface:cref /names:uppercase
