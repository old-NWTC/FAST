...
FAST Certification Test #22: NREL 5.0 MW Baseline Wind Turbine with OC3 Hywind Configuration, for use in offshore analysis
---------------------- SIMULATION CONTROL --------------------------------------
...
"FATAL"       AbortLevel      - Error level when simulation should abort {"WARNING", "SEVERE", "FATAL"} (string)
      ...
      1E+06   UJacSclFact     - Scaling factor used in Jacobians (some units)
---------------------- FEATURE FLAGS -------------------------------------------
...
"5MW_Baseline/NRELOffshrBsline5MW_Floating_OC3Hywind_MAP.dat"    MAPFile         - Name of file containing MAP input parameters (quoted string)
---------------------- OUTPUT --------------------------------------------------
