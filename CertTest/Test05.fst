...
---------------------- INPUT FILES ---------------------------------------------
"Test05_ElastoDyn.dat"    EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"Test05_AD.ipt"    ADFile      - Name of file containing AeroDyn input parameters (quoted string)
"Test05_ServoDyn.dat"    SrvDFile    - Name of file containing ServoDyn input parameters (quoted string)
