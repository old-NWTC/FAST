...
"AWT27/Test05_AD.ipt"    ADFile          - Name of file containing AeroDyn input parameters (quoted string)
"AWT27/Test05_ServoDyn.dat"    SrvDFile        - Name of file containing ServoDyn input parameters (quoted string)
