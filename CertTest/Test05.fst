...
True          GenTiStp    - Method to stop the generator {T: timed using TimGenOf, F: when generator power = 0} (flag)
     ...
     9999.9   TTpBrDp(3)  - Time to initiate deployment of tip brake 3 (s) [unused for 2 blades]
         59   TBDepISp(1) - Deployment-initiation speed for the tip brake on blade 1 (rpm)
         59   TBDepISp(2) - Deployment-initiation speed for the tip brake on blade 2 (rpm)
         59   TBDepISp(3) - Deployment-initiation speed for the tip brake on blade 3 (rpm) [unused for 2 blades]
