...
"NRELOffshrBsline5MW_Platform_Monopile_RF_noHD.dat"   PtfmFile    - Name of file containing platform properties (quoted string) [unused when PtfmModel=0]
---------------------- TOWER ---------------------------------------------------
...
"PtfmTDxi , PtfmTDyi , PtfmTDzi, PtfmRDxi , PtfmRDyi, PtfmRDzi"                  - Fore-aft, side-to-side, roll, and pitch displacements of the monopile at the mudline
