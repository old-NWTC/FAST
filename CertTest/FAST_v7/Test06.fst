...
9999.9  66.37     TBDepISp(1) - Deployment-initiation speed for the tip brake on blade 1 (rpm)
9999.9  66.37     TBDepISp(2) - Deployment-initiation speed for the tip brake on blade 2 (rpm)
9999.9  66.37     TBDepISp(3) - Deployment-initiation speed for the tip brake on blade 3 (rpm) [unused for 2 blades]
...
---------------------- TIP-BRAKE -----------------------------------------------
  ...
  10.0      TBDrConD    - Tip-brake drag constant during fully-deployed operation, Cd*Area (m^2)
