...
"AWT27/Test03_AD.ipt"    ADFile      - Name of file containing AeroDyn input parameters (quoted string)
"AWT27/Test03_ServoDyn.dat"    SrvDFile    - Name of file containing ServoDyn input parameters (quoted string)
