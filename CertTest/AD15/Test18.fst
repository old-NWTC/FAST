...
60 1        60    TMax            - Total run time (s)
0.000125     0.0125   DT              - Recommended module time step (s)
...
"C:\Users\bjonkman\Documents\DATA\DesignCodes\simulators\BeamDyn\GitforSVN\trunk\CertTest\BeamDyn_Input_5MW.inp"      BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"C:\Users\bjonkman\Documents\DATA\DesignCodes\simulators\BeamDyn\GitforSVN\trunk\CertTest\BeamDyn_Input_5MW.inp"      BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"C:\Users\bjonkman\Documents\DATA\DesignCodes\simulators\BeamDyn\GitforSVN\trunk\CertTest\BeamDyn_Input_5MW.inp"      BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
...
0.000125      0.0125   DT_Out          - Time step for tabular output (s)
          0   TStart          - Time to begin tabular output (s)
1          2   OutFileFmt      - Format for tabular (time-marching) output file (switch) {1: text file [<RootName>.out], 2: binary file [<RootName>.outb], 3: both}
