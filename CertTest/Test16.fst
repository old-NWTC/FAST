--------------------------------------------------------------------------------
------- FAST INPUT FILE --------------------------------------------------------
FAST certification Test #16: FAST model of a SWRT 3-bladed upwind turbine.  Note- SWRT rotates in CCW direction- some inputs will be mirror image of the actual turbine.
Model properties from "SWRTv1p2.adm" and SWRT "AdamsWT_MakeBladeDat_v12.xls".  JEM Jan., 2004.  Updated by J. Jonkman, NREL, Feb, 2004.  Compatible with FAST v7.02.00. - modified for FAST v8.0.0
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INITIAL CONDITIONS --------------------------------------
        ...
        188   RotSpeed    - Initial or fixed rotor speed (rpm)
          0   NacYaw      - Initial or fixed nacelle-yaw angle (degrees)
          0   TTDspFA     - Initial fore-aft tower-top displacement (meters)
          0   TTDspSS     - Initial side-to-side tower-top displacement (meters)
---------------------- TURBINE CONFIGURATION -----------------------------------
        2.9   TipRad      - The distance from the rotor apex to the blade tip (meters)
...
---------------------- DRIVETRAIN ----------------------------------------------
        100   GBoxEff     - Gearbox efficiency (%)
         83   GenEff      - Generator efficiency [ignored by the Thevenin and user-defined generator models] (%)
...
"unused"      PtfmFile    - Name of file containing platform properties (quoted string) [unused when Platform is FALSE]
---------------------- TOWER ---------------------------------------------------
...
"SWRT_Tower.dat"    TwrFile - Name of file containing tower properties (quoted string)
          0   TwrLdMod    - Additional tower loading model {0: none, 1: user-defined from routine UserTwrLd} (switch)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- AERODYN -------------------------------------------------
"Test16_AD.ipt"    ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
...
"TotWindV, HorWndDir, VerWndDir"  - Total wind speed and horizontal and vertical wind directions
"RotSpeed"                        - Rotor speed
"TailFurlP, TailFurlV, TailFurlA" - Tail-furl position (angle), velocity, and acceleration
"NacYawP, NacYawErr"              - Nacelle yaw position (angle) and yaw error
"RootFxc3, RootFyc3"              - Out-of- and in-plane shear forces at the root of blade 3
"RootMxc1, RootMyc1"              - In- and out-of-plane bending moments at the root of blade 3
"RotThrust, RotTorq, RotPwr"      - Rotor thrust, torque, and power
