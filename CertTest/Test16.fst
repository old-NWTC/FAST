...
FAST certification Test #16: FAST model of a SWRT 3-bladed upwind turbine.  Note- SWRT rotates in CCW direction- some inputs will be mirror image of the actual turbine. Model properties from "SWRTv1p2.adm" and SWRT "AdamsWT_MakeBladeDat_v12.xls".  JEM Jan., 2004.  Updated by J. Jonkman, NREL, Feb, 2004.  
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"Test16_ElastoDyn.dat"    EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"Test16_AD.ipt"    ADFile      - Name of file containing AeroDyn input parameters (quoted string)
"Test16_ServoDyn.dat"    SrvDFile    - Name of file containing ServoDyn input parameters (quoted string)
