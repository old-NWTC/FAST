...
"AWT27/Test04_AD.ipt"    ADFile          - Name of file containing AeroDyn input parameters (quoted string)
"AWT27/Test04_ServoDyn.dat"    SrvDFile        - Name of file containing ServoDyn input parameters (quoted string)
