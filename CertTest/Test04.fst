...
---------------------- INPUT FILES ---------------------------------------------
"Test04_ElastoDyn.dat"    EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"Test04_AD.ipt"    ADFile      - Name of file containing AeroDyn input parameters (quoted string)
"Test04_ServoDyn.dat"    SrvDFile    - Name of file containing ServoDyn input parameters (quoted string)
