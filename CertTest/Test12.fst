...
Model properties from "InputData1.5A08V07adm.xls" (from C. Hansen) with bugs removed.  Compatible with FAST v7.02.00. - modified for FAST v8.0.0
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- AERODYN -------------------------------------------------
"Test12_AD.ipt"    ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
"unused"      NoiseFile   - Name of file containing aerodynamic noise input parameters (quoted string) [used only when CompNoise=True]
---------------------- ADAMS ---------------------------------------------------
"Baseline_ADAMS.dat"    ADAMSFile  - Name of file containing ADAMS-specific input parameters (quoted string) [unused when ADAMSPrep=1]
...
"ES10.3E2"    OutFmt      - Format used for text tabular output (except time).  Resulting field should be 10 characters. (quoted string)  [not checked for validity!]
       ...
       0.99   ShftGagL    - Distance from rotor apex [3 blades] or teeter pin [2 blades] to shaft strain gages [positive for upwind rotors] (meters)
          ...
          2,          3,          4,          8    BldGagNd    - List of blade nodes that have strain gages [1 to BldNodes] (-) [unused if NBlGages=0]
            OutList     - The next line(s) contains a list of output parameters.  See OutList.xlsx for a listing of available output channels, (-)
"HorWindV,HorWndDir"          - Horizontal wind speed and direction
"OoPDefl3, IPDefl3"           - Blade-3 OoP and IP tip deflections
"TipALxb3, TipALyb3"          - Blade-3 flapwise and edgweise tip accelerations
"Spn4ALxb1,Spn4ALyb1"         - Blade-1 Node-8 flapwise and edgewise accelerations
"BldPitch3"                   - Blade-3 pitch angle
"RotAccel,LSSGagA,HSShftA"    - Rotor, LSS, and HSS rotation accelerations
"NacYawErr"                   - Nacelle yaw error
"RootFxb3,RootFyb3"           - Blade-3 root flapwise and edgewise shears
"RootMEdg3,RootMFlp3"         - Blade-3 root edgewise and flapwise moments
"LSShftFya,LSShftFza"         - Rotating LSS shear forces
"YawBrFxp,YawBrFyp"           - FA and SS tower-top shear forces wrt unyawed nacelle
"TwrBsFxt,TwrBsFyt"           - Tower-base FA and SS shear forces
