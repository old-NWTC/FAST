...
False       Echo        - Echo input data to "echo.out" (flag)
   ...
   2 bjj 1        AnalMode    - Analysis mode {1: Run a time-marching simulation, 2: create a periodic linearized model} (switch)
...
9999.9      TYCOn       - Time to enable active yaw control (s) [unused when YCMode=0]
   0 bjj: 1        PCMode      - Pitch control mode {0: none, 1: user-defined from routine PitchCntrl, 2: user-defined from Simulink} (switch)
...
"TwHt3MLxt, TwHt3MLyt"                                       - Local side-to-side and fore-aft bending moments at tower gage 3 (approx. tower base / monopile attachement location)
"TwHt2MLxt, TwHt2MLyt"                                       - Local side-to-side and fore-aft bending moments at tower gage 2 (approx. MSL)
"TwHt1MLxt, TwHt1MLyt"                                       - Local side-to-side and fore-aft bending moments at tower gage 1 (approx. halfway between MSL and mudline)
...
"TeetDefl , TeetDefl , TeetDefl , TeetDefl"                  - Dummy placeholders for the unavailable local fore-aft shear, side-to-side shear, side-to-side bending moment, and fore-aft bending moment of the monopile at 7m below the mudline
