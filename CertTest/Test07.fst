...
"AOC/Test07_AD.ipt"    ADFile          - Name of file containing AeroDyn input parameters (quoted string)
"AOC/Test07_ServoDyn.dat"    SrvDFile        - Name of file containing ServoDyn input parameters (quoted string)
