...
True          GenTiStp    - Method to stop the generator {T: timed using TimGenOf, F: when generator power = 0} (flag)
     ...
     9999.9   TYawManE    - Time at which override yaw maneuver reaches final yaw angle (s)
         ...
         13   TPitManS(1) - Time to start override pitch maneuver for blade 1 and end standard pitch control (s)
     9999.9   TPitManS(2) - Time to start override pitch maneuver for blade 2 and end standard pitch control (s)
     9999.9   TPitManS(3) - Time to start override pitch maneuver for blade 3 and end standard pitch control (s) [unused for 2 blades]
         15   TPitManE(1) - Time at which override pitch maneuver for blade 1 reaches final pitch (s)
     ...
     9999.9   TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
        ...
        7.5   BlPitch(3)  - Blade 3 initial pitch (degrees) [unused for 2 blades]
         45   BlPitchF(1) - Blade 1 final pitch for pitch maneuvers (degrees)
...
---------------------- AERODYN -------------------------------------------------
"Test11_AD.ipt"    ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
...
"OoPDefl1, OoPDefl3"                      - OoP blade 1,3 tip deflections
"TipALxb1"                                - Blade 1 flapwise tip acceleration
"RootMxb1, RootMyb1, RootMzb1"            - Blade 1 root moments
"RotThrust, LSShftFya, LSShftFza"         - Rotor thrust and rotating LSS shear forces
"LSSTipMya, LSSTipMza"                    - Rotating LSS bending moments at the shaft tip
