...
Compatible with FAST v7.02.00. - modified for FAST v8.0.0
---------------------- SIMULATION CONTROL --------------------------------------
...
True          GenTiStp    - Method to stop the generator {T: timed using TimGenOf, F: when generator power = 0} (flag)
     9999.9   SpdGenOn    - Generator speed to turn on the generator for a startup (HSS speed) (rpm) [used only when GenTiStr=False]
         ...
         12   TimGenOf    - Time to turn off the generator (s) [used only when GenTiStp=True]
          1   HSSBrMode   - HSS brake model {1: simple, 2: user-defined from routine UserHSSBr} (switch)
         13   THSSBrDp    - Time to initiate deployment of the HSS brake (s)
     ...
     9999.9   TPitManE(3) - Time at which override pitch maneuver for blade 3 reaches final pitch (s) [unused for 2 blades]
         ...
         -1   BlPitchF(1) - Blade 1 final pitch for pitch maneuvers (degrees)
         -1   BlPitchF(2) - Blade 2 final pitch for pitch maneuvers (degrees)
         -1   BlPitchF(3) - Blade 3 final pitch for pitch maneuvers (degrees) [unused for 2 blades]
...
---------------------- SIMPLE INDUCTION GENERATOR ------------------------------
     1.5125   SIG_SlPc    - Rated generator slip percentage (%) [used only when VSContrl=0 and GenModel=1]
       1200   SIG_SySp    - Synchronous (zero-torque) generator speed (rpm) [used only when VSContrl=0 and GenModel=1]
...
---------------------- THEVENIN-EQUIVALENT INDUCTION GENERATOR -----------------
     ...
     0.0185   TEC_SRes    - Stator resistance (ohms) [used only when VSContrl=0 and GenModel=2]
      ...
      0.034   TEC_SLR     - Stator leakage reactance (ohms) [used only when VSContrl=0 and GenModel=2]
      0.005   TEC_RLR     - Rotor leakage reactance (ohms) [used only when VSContrl=0 and GenModel=2]
      0.775   TEC_MR      - Magnetizing reactance (ohms) [used only when VSContrl=0 and GenModel=2]
---------------------- PLATFORM ------------------------------------------------
...
---------------------- TIP-BRAKE -----------------------------------------------
      ...
      0.007   TBDrConD    - Tip-brake drag constant during fully-deployed operation, Cd*Area (m^2)
...
---------------------- AERODYN -------------------------------------------------
"Test02_AD.ipt"    ADFile     - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
...
"RootFxb2,RootFyb2"             - Blade-2 flapwise and edgewise shear
"RootMIP2,RootMOoP2"            - Blade-2 IP and OoP bending moments
"Spn1MLxb1,Spn1MLyb1"           - Blade-1, Node-5 edgewise and flapwise bending moments
"RotTorq"                       - Rotor torque
"LSSTipMys,LSSTipMzs"           - LSS tip non-rotating bending moments
