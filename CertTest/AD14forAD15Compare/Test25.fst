...
"../5MW_Baseline/NRELOffshrBsline5MW_AeroDyn_Equil_noTwr - Copy.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
...
"../5MW_Baseline/NRELOffshrBsline5MW_OC4DeepCwindSemi_MAP.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
