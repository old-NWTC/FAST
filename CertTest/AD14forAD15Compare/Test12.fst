...
"../WP_Baseline/WP_Baseline_AeroDyn_Dynin - Copy.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
...
3          1   OutFileFmt      - Format for tabular (time-marching) output file (switch) {1: text file [<RootName>.out], 2: binary file [<RootName>.outb], 3: both}
