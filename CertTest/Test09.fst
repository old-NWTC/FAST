...
True          GenTiStp    - Method to stop the generator {T: timed using TimGenOf, F: when generator power = 0} (flag)
     ...
     9999.9   TBDepISp(3) - Deployment-initiation speed for the tip brake on blade 3 (rpm) [unused for 2 blades]
         10   TYawManS    - Time to start override yaw maneuver and end standard yaw control (s)
         30   TYawManE    - Time at which override yaw maneuver reaches final yaw angle (s)
        -45   NacYawF     - Final yaw angle for yaw maneuvers (degrees)
...
---------------------- NACELLE-YAW ---------------------------------------------
     100000   YawSpr      - Nacelle-yaw spring constant (N-m/rad)
       2000   YawDamp     - Nacelle-yaw damping constant (N-m/(rad/s))
         30   YawNeut     - Neutral yaw position--yaw spring force is zero at this yaw (degrees)
---------------------- FURLING -------------------------------------------------
