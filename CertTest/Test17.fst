...
"SWRT/Test17_AD.ipt"    ADFile          - Name of file containing AeroDyn input parameters (quoted string)
"SWRT/Test17_ServoDyn.dat"    SrvDFile        - Name of file containing ServoDyn input parameters (quoted string)
