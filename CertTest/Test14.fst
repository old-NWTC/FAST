...
"unused"      DynBrkFi    - File containing a mech-gen-torque vs HSS-speed curve for a dynamic brake [CURRENTLY IGNORED] (quoted string)
    5.6E+09   DTTorSpr    - Drivetrain torsional spring (N-m/rad)
          0   DTTorDmp    - Drivetrain torsional damper (N-m/(rad/s))
...
"Baseline_Tower_NoDamp.dat"    TwrFile - Name of file containing tower properties (quoted string)
...
---------------------- BLADE ---------------------------------------------------
"Baseline_Blade_NoDamp.dat"    BldFile(1) - Name of file containing properties for blade 1 (quoted string)
"Baseline_Blade_NoDamp.dat"    BldFile(2) - Name of file containing properties for blade 2 (quoted string)
"Baseline_Blade_NoDamp.dat"    BldFile(3) - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
