...
WRITE(UnNoSPL,Frmt)  '    Time',  p%Delim, '  Azimuth',((p%Delim, 'Bl', J,'-Elem', I, I = 1,p%BldNodes), J = 1,p%NumBl)
...
WRITE (UnNoSpec,'(/,1X,A,/)')  TRIM( FTitle )
      ...
      WRITE(UnNoSpec,  '(/I7,5X,3X,A)') p%BldNodes   , ' NUMBER OF SEGMENTS                         ---     '
