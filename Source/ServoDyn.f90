...
! ===================================================================================================
! This code was generated by Write_ChckOutLst.m at 06-Feb-2015 13:20:16.
...
!..................................................................................................................................
   ...
   ELSE
      ...
      IF ( InputFileData%VSContrl == ControlMode_EXTERN  ) THEN  !we don't know TMax anymore...
...
!         IF ( .NOT. InputFileData%GenTiStp .OR. InputFileData%TimGenOf <= TMax ) THEN   !BJJ SET p%TimGenOf = HUGE() when Cmpl4SFun .OR. Cmpl4LV
   ...
   IF ( .NOT. Cmpl4LV .AND. InputFileData%HSSBrMode == ControlMode_EXTERN )  THEN
      CALL SetErrors( ErrID_Fatal, 'HSSBrMode can be '//TRIM(Num2LStr(ControlMode_EXTERN))//' only when when implemented in LabVIEW.' )
   ENDIF      
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(12) =  (/ &                  ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "BLPITCHC1","BLPITCHC2","BLPITCHC3","GENPWR   ","GENTQ    ","HSSBRTQ  ","NTMD_XQ  ", &
