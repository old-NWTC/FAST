...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
      Int_BufSz  = Int_BufSz  + 1  ! IdNum
      Int_BufSz  = Int_BufSz  + 1*LEN(InData%type)  ! type
      Int_BufSz  = Int_BufSz  + 1*LEN(InData%OutFlags)  ! OutFlags
  ...
  Int_Xferred = 1
      ...
      Int_Xferred   = Int_Xferred   + 1
        DO I = 1, LEN(InData%type)
          ...
          Int_Xferred = Int_Xferred   + 1
        END DO ! I
        DO I = 1, LEN(InData%OutFlags)
          IntKiBuf(Int_Xferred) = ICHAR(InData%OutFlags(I:I), IntKi)
          Int_Xferred = Int_Xferred   + 1
        END DO ! I
 ...
 ! buffers to store meshes, if any
  ...
  Int_Xferred  = 1
      ...
      DO I = 1, LEN(OutData%type)
        ...
        Int_Xferred = Int_Xferred   + 1
      END DO ! I
      DO I = 1, LEN(OutData%OutFlags)
        OutData%OutFlags(I:I) = CHAR(IntKiBuf(Int_Xferred))
        Int_Xferred = Int_Xferred   + 1
      END DO ! I
...
!..................................................................................................................................
 ...
 SUBROUTINE MD_Output_ExtrapInterp(y, tin, y_out, tin_out, ErrStat, ErrMsg )
!
...
!..................................................................................................................................
 ...
 if ( size(t) .ne. size(y)) then
    ErrStat = ErrID_Fatal
    ErrMsg = ' Error in MD_Output_ExtrapInterp: size(t) must equal size(y) '
    RETURN
 endif
 if (size(y) .gt. 3) then
    ErrStat = ErrID_Fatal
    ErrMsg  = ' Error in MD_Output_ExtrapInterp: size(y) must be less than 4 '
    RETURN
 endif
 order = SIZE(y) - 1
 IF ( order .eq. 0 ) THEN
