...
MODULE HydroDyn_Output
  ...
  CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(21) =  (/ &                  ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "ADDFXI   ","ADDFYI   ","ADDFZI   ","ADDMXI   ","ADDMYI   ","ADDMZI   ","HYDROFXI ", &
                               "HYDROFYI ","HYDROFZI ","HYDROMXI ","HYDROMYI ","HYDROMZI ","WAVE1ELEV","WAVE2ELEV", &
                               "WAVE3ELEV","WAVE4ELEV","WAVE5ELEV","WAVE6ELEV","WAVE7ELEV","WAVE8ELEV","WAVE9ELEV"/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(21) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                   AddFxi ,    AddFyi ,    AddFzi ,    AddMxi ,    AddMyi ,    AddMzi ,   HydroFxi , &
                                  HydroFyi ,   HydroFzi ,   HydroMxi ,   HydroMyi ,   HydroMzi , Wave1Elev , Wave2Elev , &
                                Wave3Elev , Wave4Elev , Wave5Elev , Wave6Elev , Wave7Elev , Wave8Elev , Wave9Elev /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(21) =  (/ &                     ! This lists the units corresponding to the allowed parameters
                               "(N)       ","(N)       ","(N)       ","(N·m)     ","(N·m)     ","(N·m)     ","(N)       ", &
                               "(N)       ","(N)       ","(N·m)     ","(N·m)     ","(N·m)     ","(m)       ","(m)       ", &
                               "(m)       ","(m)       ","(m)       ","(m)       ","(m)       ","(m)       ","(m)       "/)
...
!====================================================================================================
SUBROUTINE HDOut_MapOutputs( CurrentTime, y, NWaveElev, WaveElev, F_Add, F_Hydro, AllOuts, ErrStat, ErrMsg )
