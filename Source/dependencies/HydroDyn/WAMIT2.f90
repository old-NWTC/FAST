...
!   INTEGER(IntKi), PARAMETER                             :: DataFormatID = 1  !< Update this value if the data types change (used in WAMIT_Pack)
   TYPE(ProgDesc), PARAMETER                             :: WAMIT2_ProgDesc = ProgDesc( 'WAMIT2', 'v1.00.00-adp', '08-Sept-2014' )
...
SUBROUTINE WAMIT2_Init( InitInp, u, p, x, xd, z, OtherState, y, Interval, InitOut, ErrStat, ErrMsg )
!..................................................................................................................................
      ...
      TYPE(WAMIT2_OtherStateType),        INTENT(  OUT)  :: OtherState           !< Initial other/optimization states
...
!!
SUBROUTINE WAMIT2_End( u, p, x, xd, z, OtherState, y, ErrStat, ErrMsg )
!..................................................................................................................................
      ...
      TYPE(WAMIT2_OtherStateType),        INTENT(INOUT)  :: OtherState     !< Other/optimization states
...
SUBROUTINE WAMIT2_UpdateStates( t, n, Inputs, InputTimes, p, x, xd, z, OtherState, ErrStat, ErrMsg )
!..................................................................................................................................
...
SUBROUTINE WAMIT2_CalcOutput( Time, u, p, x, xd, z, OtherState, y, ErrStat, ErrMsg )
!..................................................................................................................................
      ...
      DO I=1,3
         y%Mesh%Force(I,1)    = OtherState%F_Waves2(I)
      END DO
      DO I=1,3
         y%Mesh%Moment(I,1)   = OtherState%F_Waves2(I+3)
      END DO



         ! Map the calculated results into the AllOuts Array
      CALL WMT2Out_MapOutputs(Time, y, OtherState%F_Waves2, AllOuts, ErrStat, ErrMsg)
...
SUBROUTINE WAMIT2_CalcContStateDeriv( Time, u, p, x, xd, z, OtherState, dxdt, ErrStat, ErrMsg )
!..................................................................................................................................
...
SUBROUTINE WAMIT2_UpdateDiscState( Time, n, u, p, x, xd, z, OtherState, ErrStat, ErrMsg )
!..................................................................................................................................
...
!! So, this routine will simply issue a warning and return.
!! @note A few values will be set so that compilers are happy, but nothing of value is done.
SUBROUTINE WAMIT2_CalcConstrStateResidual( Time, u, p, x, xd, z, OtherState, z_residual, ErrStat, ErrMsg )
!..................................................................................................................................
...
!The following pieces of code are not currently used.  Perhaps one day they will be, but they may not be necessary given how WAMIT2
!  funcitons.  For now they are kept so that this module complies with the FAST framework.
!
!----------------------------------------------------------------------------------------------------------------------------------
!SUBROUTINE WAMIT2_JacobianPInput( Time, u, p, x, xd, z, OtherState, dYdu, dXdu, dXddu, dZdu, ErrStat, ErrMsg )
...
!      TYPE(WAMIT2_ConstraintStateType),         INTENT(IN   )           :: z          ! Constraint states at Time
!      TYPE(WAMIT2_OtherStateType),              INTENT(INOUT)           :: OtherState ! Other/optimization states
!      TYPE(WAMIT2_PartialOutputPInputType),     INTENT(  OUT), OPTIONAL :: dYdu       ! Partial derivatives of output equations
!                                                                                       !   (Y) with respect to the inputs (u)
!      TYPE(WAMIT2_PartialContStatePInputType),  INTENT(  OUT), OPTIONAL :: dXdu       ! Partial derivatives of continuous state
!                                                                                       !   equations (X) with respect to inputs (u)
!      TYPE(WAMIT2_PartialDiscStatePInputType),  INTENT(  OUT), OPTIONAL :: dXddu      ! Partial derivatives of discrete state
!                                                                                       !   equations (Xd) with respect to inputs (u)
!      TYPE(WAMIT2_PartialConstrStatePInputType),INTENT(  OUT), OPTIONAL :: dZdu       ! Partial derivatives of constraint state
...
!
!
!END SUBROUTINE WAMIT2_JacobianPInput
!!----------------------------------------------------------------------------------------------------------------------------------
!SUBROUTINE WAMIT2_JacobianPContState( Time, u, p, x, xd, z, OtherState, dYdx, dXdx, dXddx, dZdx, ErrStat, ErrMsg )
!! Routine to compute the Jacobians of the output (Y), continuous- (X), discrete- (Xd), and constraint-state (Z) equations
...
!      TYPE(WAMIT2_ConstraintStateType),             INTENT(IN   )           :: z          ! Constraint states at Time
!      TYPE(WAMIT2_OtherStateType),                  INTENT(INOUT)           :: OtherState ! Other/optimization states
!      TYPE(WAMIT2_PartialOutputPContStateType),     INTENT(  OUT), OPTIONAL :: dYdx       ! Partial derivatives of output equations
!                                                                                           !   (Y) with respect to the continuous
!                                                                                           !   states (x)
!      TYPE(WAMIT2_PartialContStatePContStateType),  INTENT(  OUT), OPTIONAL :: dXdx       ! Partial derivatives of continuous state
!                                                                                           !   equations (X) with respect to
!                                                                                           !   the continuous states (x)
!      TYPE(WAMIT2_PartialDiscStatePContStateType),  INTENT(  OUT), OPTIONAL :: dXddx      ! Partial derivatives of discrete state
!                                                                                           !   equations (Xd) with respect to
!                                                                                           !   the continuous states (x)
!      TYPE(WAMIT2_PartialConstrStatePContStateType),INTENT(  OUT), OPTIONAL :: dZdx       ! Partial derivatives of constraint state
...
!
!
!   END SUBROUTINE WAMIT2_JacobianPContState
!!----------------------------------------------------------------------------------------------------------------------------------
!SUBROUTINE WAMIT2_JacobianPDiscState( Time, u, p, x, xd, z, OtherState, dYdxd, dXdxd, dXddxd, dZdxd, ErrStat, ErrMsg )
!! Routine to compute the Jacobians of the output (Y), continuous- (X), discrete- (Xd), and constraint-state (Z) equations
...
!      TYPE(WAMIT2_ConstraintStateType),             INTENT(IN   )           :: z          ! Constraint states at Time
!      TYPE(WAMIT2_OtherStateType),                  INTENT(INOUT)           :: OtherState ! Other/optimization states
!      TYPE(WAMIT2_PartialOutputPDiscStateType),     INTENT(  OUT), OPTIONAL :: dYdxd      ! Partial derivatives of output equations
!                                                                                           !  (Y) with respect to the discrete
!                                                                                           !  states (xd)
!      TYPE(WAMIT2_PartialContStatePDiscStateType),  INTENT(  OUT), OPTIONAL :: dXdxd      ! Partial derivatives of continuous state
!                                                                                           !   equations (X) with respect to the
!                                                                                           !   discrete states (xd)
!      TYPE(WAMIT2_PartialDiscStatePDiscStateType),  INTENT(  OUT), OPTIONAL :: dXddxd     ! Partial derivatives of discrete state
!                                                                                           !   equations (Xd) with respect to the
!                                                                                           !   discrete states (xd)
!      TYPE(WAMIT2_PartialConstrStatePDiscStateType),INTENT(  OUT), OPTIONAL :: dZdxd      ! Partial derivatives of constraint state
...
!
!
!END SUBROUTINE WAMIT2_JacobianPDiscState
!!----------------------------------------------------------------------------------------------------------------------------------
!SUBROUTINE WAMIT2_JacobianPConstrState( Time, u, p, x, xd, z, OtherState, dYdz, dXdz, dXddz, dZdz, ErrStat, ErrMsg )
!! Routine to compute the Jacobians of the output (Y), continuous- (X), discrete- (Xd), and constraint-state (Z) equations
...
!      TYPE(WAMIT2_ConstraintStateType),               INTENT(IN   )           :: z          ! Constraint states at Time
!      TYPE(WAMIT2_OtherStateType),                    INTENT(INOUT)           :: OtherState ! Other/optimization states
!      TYPE(WAMIT2_PartialOutputPConstrStateType),     INTENT(  OUT), OPTIONAL :: dYdz       ! Partial derivatives of output
!                                                                                             !  equations (Y) with respect to the
!                                                                                             !  constraint states (z)
!      TYPE(WAMIT2_PartialContStatePConstrStateType),  INTENT(  OUT), OPTIONAL :: dXdz       ! Partial derivatives of continuous
!                                                                                             !  state equations (X) with respect to
!                                                                                             !  the constraint states (z)
!      TYPE(WAMIT2_PartialDiscStatePConstrStateType),  INTENT(  OUT), OPTIONAL :: dXddz      ! Partial derivatives of discrete state
!                                                                                             !  equations (Xd) with respect to the
!                                                                                             !  constraint states (z)
!      TYPE(WAMIT2_PartialConstrStatePConstrStateType),INTENT(  OUT), OPTIONAL :: dZdz       ! Partial derivatives of constraint
...
!
!
!END SUBROUTINE WAMIT2_JacobianPConstrState
