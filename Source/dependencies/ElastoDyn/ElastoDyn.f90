...
!
!**********************************************************************************************************************************
! File last committed: $Date: 2015-08-20 11:52:34 -0600 (Thu, 20 Aug 2015) $
! (File) Revision #: $Rev: 1089 $
...
MODULE ElastoDyn_Parameters
   ...
   TYPE(ProgDesc), PARAMETER  :: ED_Ver = ProgDesc( 'ElastoDyn', 'v1.03.00a-bjj', '9-Jul-2015' )
