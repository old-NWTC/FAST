...
!..................................................................................................................................
   ...
   CALL WrScr( NewLine//' Running '//CompiledVer//NewLine )
   
   !we should probably also display the licensing agreement, no?   
...
TYPE(ProgDesc), INTENT(IN) :: AD_prog ! aerodyn version    
   ...
   y_FAST%FileDescLines(2)  = 'linked with the following modules:' &
...
DO K=1,p%NumBl
   ...
   IF ( GenerateAdamsModel )  THEN  ! An ADAMS model will be created; thus, print out all the cols.
      ...
      WRITE (UnSu,FmtTxt)  'Node  BlFract   RNodes  DRNodes   StrcTwst  BMassDen    FlpStff    EdgStff'//       &
      ...
      DO I=1,p%BldNodes
         ...
         WRITE(UnSu,'(I4,3F9.3,2F10.3,4ES11.3,F9.3,4F10.3,4F9.3)')  I, p%RNodesNorm(I),  p%RNodes(I) + p%HubRad, p%DRNodes(I), &
